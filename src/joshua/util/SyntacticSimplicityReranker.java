...
public class SyntacticSimplicityReranker {
	...
	public static void main(String[] args) {
		...
		String usage = "java joshua.util.SyntacicSimplicityReranker referencefilepath nbestlistpath metric metric_params ..";
		if (args.length < 2) {
	...
	private void initializeMetric(String refPath) {
		String[] metricOptions = new String[EvaluationMetric.metricOptionCount("SYN_SIMP")];
		metricOptions[0] = "4";
		metricOptions[1] = "closest";
		metricOptions[2] = "0";
		metricOptions[3] = "0";
		metricOptions[4] = refPath;

		ssMetric = new SyntacticSimplicityMetric(metricOptions);
